...
wget -q https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
# izin
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/izin | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/izin | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/Insshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O ins-xray.sh https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
sleep 1
wget -q -O senmenu.sh https://raw.githubusercontent.com/kanghoryVPN/xray-ws-V1/main/senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
